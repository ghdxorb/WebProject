...
<c:if test="${empty user}">
     <p align="center"><font color="white" size="2"><b><a href="/User?cmd=userLogin" class="white">로그인</A></b></font></p>
</c:if>
<c:if test="${!empty user}">
...
<c:if test="${empty user}">
     <p align="center"><font color="white" size="2"><b><a href="/User?cmd=userWrite" class="white">회원가입</a></b></font></p>
</c:if>
<c:if test="${!empty user}">
     ...
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/Notice?cmd=noticeList" class="white">공지사항</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/Board?cmd=boardList" class="white">자유게시판</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/BoardPhoto?cmd=boardPhotoList" class="white">포토게시판</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/Pds?cmd=pdsList" class="white">자료실</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/Gallery?cmd=galleryList" class="white">겔러리</a></b></font></p>
     </td>
     <td bgcolor="#9966ff" width="10%" onmouseover="style.backgroundColor='#2772D3'" onmouseout="style.backgroundColor=''">
     <p align="center"><font color="white" size="2"><b><a href="/Admin?cmd=adminLogin" class="white">관리자</a></b></font></p>
     </td>
   </tr>                   
   <tr>
     <td colspan="8">
   ...
   <tr>
     <td colspan="8"><p><img src="/Images/img/bar-01.gif" width="100%" height="1" border="0"></p></td>
   </tr>
   <tr>
     ...
     <p>&nbsp;
       ...
       <Select name="item" size="1">
         ...
         <input type="image" src="/Images/img/search2.gif">
     </td>
     </form>
   </tr>
 </table>  
